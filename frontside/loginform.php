...
{ 
 ...
 {
  echo'You entered email  is not present';
 }
}
//database connection
//session_start();
//$_SESSION['login']= $email;  // Initializing Session with value of PHP Variable
//echo $_SESSION['login'];
    ...
    <div class="col-md-12 row-left">
      ...
      <div id="customer-login">
        ...
        <div class="checkout-title">
          <span class="general-title">Login</span>
        </div>
        ...
        <ul id="login-form" class="list-unstyled">
          ...
          <li id="email" class="col-md-21">
            <label class="control-label" for="email">email  <span class="req">*</span></label>
            <input type="email" value="" name="email" id="email" class="form-control email" />
          </li>
          <li class="clearfix"></li>
          
          <li id="password" class="col-md-21">
            <label class="control-label" for="password">password  <span class="req">*</span></label>
            <input type="password" value="" name="password" id="password" class="form-control password" />
          </li>
          ...
          <li class="col-md-21 unpadding-top">
            ...
            <ul class="login-wrapper list-unstyled">              
              ...
              <li>
               <a href="registration.php" class="btn btn-dfault btn-flat">Registration</a>
              </li>
              <li>
      ...
      <div id="recover-password" style="display: none;">
        ...
        <form method="post" action="" accept-charset="UTF-8"><input type="hidden" name="form_type" value="recover_password" /><input type="hidden" name="utf8" value="✓" />
        ...
        <ul id="recover-form" class="list-unstyled clearfix">
          ...
          <li>
              <!--<a href="forgotpassword.php" button class="btn btn-1" type="submit">Submit</button></a>-->
              <button type="submit" name="fsubmit" class="btn btn-1">Submit</button>
          </li>
        </ul>
          </li>
        </ul>

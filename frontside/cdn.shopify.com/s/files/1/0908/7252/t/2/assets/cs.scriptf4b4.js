...
var switchImage = function(newImageSrc, newImage, mainImageDomEl, newalt) {
    
  var str = newalt;
  if(newalt != undefined)
  {
    if(newalt.indexOf('iframe') >= 0){      
      $('.featured img').hide();
      $('.featured span').html(newalt);
    }
    else{
      $('.featured span').html("");
      $('.featured img').show();      
...
jQuery(document).ready(function($) {
  ...
  $('#product .thumbs a').on('click', function(e) {
    ...
    switchImage($(this).attr('href'), null, $('.featured img')[0], $(this).attr('alt'));
  });

...
<div class="collection-image col-sm-24 text-center">      
    <img src="cdn.shopify.com/s/files/1/0908/7252/collections/512714PPHAAA00_thumbnail.jpg?v=1435637330" alt="Rings" />      
    </div>
  </div>
</div>
        ...
        <div class="sortBy">
            ...
            <div id="sortBox" class="control-container dropdown-menu">
              <ul id="sortForm" class="list-unstyled option-set text-left list-styled" data-option-key="sortBy">
                <li class="sort manual"><a href="pendants/indexd07c.html?sort_by=manual">Featured</a></li>
                <li class="sort price-ascending"><a href="pendants/index7c28.html?sort_by=price-ascending">Price: Low to High</a></li>
                <li class="sort price-descending"><a href="pendants/index87b3.html?sort_by=price-descending">Price: High to Low</a></li>
                <li class="sort title-ascending"><a href="pendants/index911b.html?sort_by=title-ascending">A-Z</a></li>
                <li class="sort title-descending"><a href="pendants/index0466.html?sort_by=title-descending">Z-A</a></li>
                <li class="sort created-ascending"><a href="pendants/index6868.html?sort_by=created-ascending">Oldest to Newest</a></li>
                <li class="sort created-descending"><a href="pendants/index3f84.html?sort_by=created-descending">Newest to Oldest</a></li>
                <li class="sort best-selling"><a href="pendants/index51e5.html?sort_by=best-selling">Best Selling</a></li>
              </ul>
            </div>
          </div>        
      </ul>
...
//                $product_id = $_GET['product_id'];
               ...
               $data = "SELECT product_name,image FROM product where product_name ='pendants'";            
...
//                echo "<pre>"; print_r($path);die();
	  ...
	  <div class="product-content-left">
        <a class="title-5" href="pendants/products/gravida-est-quis-euismod.html">Gravida est quis euismod</a>        
